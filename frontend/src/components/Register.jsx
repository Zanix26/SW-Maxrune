    ...
    return (
        <div className="flex items-center justify-center min-h-screen">
            <div className="bg-gray-800 bg-opacity-80 p-8 rounded-lg shadow-xl w-full max-w-md border border-gray-700">
                <h1 className="text-3x1 font-bold text-center mana-gradient mb-6">Werde ein Summoner!</h1>
                <form onSubmit={handleSubmit}>
                    <div className="mb-6">
                        <label className="block text-gray-300 text-sm font-semibold mb-2">Benutzername</label>
                        <input
                            type="text"
                            value={username}
